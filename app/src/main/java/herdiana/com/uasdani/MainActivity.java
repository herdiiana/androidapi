    ...
    private void processResponse(String response) {
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                contact = new Contact();
                contact.setName(obj.getString("contacts_name"));
                contact.setEmail(obj.getString("contacs_email"));
                contact.setAddress(obj.getString("contacts_address"));
                contact.setGender(obj.getString("contacts_gender"));
                contact.setMobile(obj.getString("contacts_phone_mobile"));
                contact.setHome(obj.getString("contacts_phone_home"));
                contact.setOffice(obj.getString("contacts_phone_office"));
